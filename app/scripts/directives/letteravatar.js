...
/**
 * @ngdoc directive
 * @name mobileDirect.directive:LetterAvatar
 * @description
 * # LetterAvatar
 */
angular
        ...
        return {
            ...
            link: function(scope, element, attrs) {
                ...
                if (c.charCodeAt(0) < 65) {
                    ...
                    colorIndex = Math.floor((c.charCodeAt(0) + seed) % params.alphabetcolors.length);
                ...
                if (params.shape) {
                    if (params.shape === "round") {
                        ...
                        component = "<img src=" + base + svgHtml + " style='" + roundStyle + "' />";
                    }
                } else {
